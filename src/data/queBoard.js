export default {
  202104: {
    q0: {
      ...
      qImg: 'm4-s-1-1.png',
      qText: '대기업 영업관리 별과장, 나이 45세, 키 180cm, 몸무게 80kg으로\n 말끔한 외모에 가정적인 성격의 소유자. 10년 이상의 금연 생활에 술도\n 한달에 두어 번 정도로 평소에 건강은 자신 있어 했는데…\n 얼마전 태어난 둘째의 매력에 푹 빠져 지내던 그는, 올해 건강검진에서\n 혈압 143/95mmHg로 고혈압 진단을 받아서 본인 뿐만 아니라 주변\n 사람들 모두 놀라고 있음.',
      img: 'doctors.png',
    },
    q1: {
      qImg: 'm4-s-1-0.png',
