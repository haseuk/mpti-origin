export default {
  4: {
    ...
    q9: {
      ...
      aImg: 'm4-s-9-2.png',
      examples: [
        {idx: 'a', label: '유일한 텔미사르탄 20mg 저용량 제제로 유연한 처방 가능'},
        {idx: 'b', label: '비교적 작은 알약 사이즈'},
        {idx: 'c', label: '텔미트렌 브랜드명으로 20mg, 40mg, 80mg 전 라인업 보유하여 용량 변경 시 처방전 상의 브랜드명 및 회사명이 유지됨'},
        {idx: 'd', label: '신뢰할수있는회사제품'},
        {idx: 'e', label: '기타'},
      ],
      next: 'roulette',
      type: 'radio',
